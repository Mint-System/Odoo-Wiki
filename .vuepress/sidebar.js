    ...
    children: [
      {
        text: 'Subscription',
        collapsible: true,
        children: ['subsciption-actions.md'],
      },
      {
        text: 'HR Holidays',
        collapsible: true,
        children: ['hr-holidays-actions.md', 'hr-holidays-data-management.md'],
      },
      {
        text: 'HR Attendance',
        collapsible: true,
        children: ['hr-attendance-actions.md', 'hr-attendance-overtime.md'],
      },
      {
        text: 'Apps',
        collapsible: true,
        children: ['apps-actions.md'],
      },
      {
        text: 'Accounting',
        collapsible: true,
      ...
      },
      {
        text: 'Documents',
        collapsible: true,
        children: ['documents-actions.md'],
      },
      {
        text: 'Purchase',
        collapsible: true,
        children: ['purchase-actions.md'],
      },
      {
        text: 'Settings',
        collapsible: true,
      ...
      },
      {
        text: 'Mass Mailing',
        collapsible: true,
        children: ['mass-mailing-action.md'],
      },
      {
        text: 'Development',
        collapsible: true,
      ...
      },
      {
        text: 'IoT',
        collapsible: true,
        children: ['labelprinter-zebra-zd410.md'],
      },
      {
        text: 'Calendar',
        collapsible: true,
        children: ['calendar-actions.md'],
      },
      {
        text: 'Contacts',
        collapsible: true,
        children: ['partner-actions.md', 'partner-data-management.md'],
      },
      {
        text: 'Helpdesk',
        collapsible: true,
        children: ['helpdesk-actions.md', 'helpdesk-data-management.md'],
      },
      {
        text: 'Stock',
        collapsible: true,
      ...
      },
      {
        text: 'HR',
        collapsible: true,
        children: ['hr-activities.md', 'hr-contract.md'],
      },
      {
        text: 'HR Payroll',
        collapsible: true,
      ...
      },
      {
        text: 'Product',
        collapsible: true,
        children: ['product-actions.md'],
      },
      {
        text: 'Project',
        collapsible: true,
        children: ['project-actions.md', 'project-data-management.md'],
      },
      {
        text: 'Quality',
        collapsible: true,
        children: ['quality-actions.md'],
      },
      {
        text: 'Invoicing',
        collapsible: true,
        children: ['invoicing-reminder.md', 'invoicing-actions.md'],
      },
      {
        text: 'HR Expense',
        collapsible: true,
        children: ['hr-expense-actions.md'],
      },
      {
        text: 'Barcode',
        collapsible: true,
        children: ['scanner-zebra-tc21.md'],
      },
      {
        text: 'Studio',
        collapsible: true,
        children: ['studio-examples.md'],
      },
      {
        text: 'Survey',
        collapsible: true,
        children: ['survey-datamanagement.md'],
      },
      {
        text: 'Sale',
        collapsible: true,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        text: 'FSM Industry',
        collapsible: true,
        children: ['industry-fsm-sale-default-task.md'],
      },
      {
        text: 'Accounting',
        collapsible: true,
      ...
      },
      {
        text: 'Connector',
        collapsible: true,
        children: ['git-base.md', 'meilisearch-base.md', 'ssh.md'],
      },
      {
        text: 'Dashboards',
        collapsible: true,
      ...
      },
      {
        text: 'Fleet',
        collapsible: true,
        children: ['fleet-hr-vehicle-request.md'],
      },
      {
        text: 'IoT',
        collapsible: true,
        children: ['printnode-base.md'],
      },
      {
        text: 'Calendar',
        collapsible: true,
        children: ['caldav-sync.md'],
      },
      {
        text: 'Contacts',
        collapsible: true,
      ...
      },
      {
        text: 'Helpdesk',
        collapsible: true,
        children: ['helpdesk-management.md'],
      },
      {
        text: 'Stock',
        collapsible: true,
      ...
      },
      {
        text: 'HR Payroll',
        collapsible: true,
        children: ['lohnmeldung.md', 'gio-payroll-custom.md'],
      },
      {
        text: 'HR Recruitment',
        collapsible: true,
        children: ['hr-recruitment-firstname.md'],
      },
      {
        text: 'Product',
        collapsible: true,
      ...
      },
      {
        text: 'Spreadsheet',
        collapsible: true,
        children: ['spreadsheet-board-user-acl.md'],
      },
      {
        text: 'Barcode',
        collapsible: true,
        children: ['stock-barcode-mrp.md', 'stock-barcode-maintenance.md'],
      },
      {
        text: 'Survey',
        collapsible: true,
        children: ['survey-question-type-nps.md'],
      },
      {
        text: 'Sale',
        collapsible: true,
      ...
      },
      {
        text: 'Brand',
        collapsible: true,
        children: ['brand-account.md', 'brand-external-report-layout.md'],
      },
      {
