...
var MetadataReader = (function () {
    ...
    MetadataReader2.prototype.getPropertiesMetadata = function (
        constructorFunc
    ) {
...
function circularDependencyToException(request) {
    request.childRequests.forEach(function (childRequest) {
        if (
            alreadyDependencyChain(childRequest, childRequest.serviceIdentifier)
        ) {
...
function _createInstance(constr, childRequests, resolveRequest) {
    ...
    if (childRequests.length > 0) {
        ...
        var createInstanceWithInjectionsArg = __assign(
            __assign({}, resolved2),
            { constr }
        )
        if (resolved2.isAsync) {
            ...
            result = createInstanceWithInjections(
                createInstanceWithInjectionsArg
            )
        }
    } else {
        ...
        return __generator2(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4,
                        possiblyWaitInjections(args.constructorInjections),
                    ]
                case 1:
...
function _onActivation(request, binding, resolved2) {
    ...
    do {
        ...
        if (isPromise(result)) {
            result = _activateContainerAsync(
                activationsIterator,
                context_1,
                result
            )
...
var BindingWhenSyntax = (function () {
    ...
    BindingWhenSyntax2.prototype.whenAnyAncestorMatches = function (
        constraint
    ) {
        this._binding.constraint = function (request) {
...
var BindingWhenOnSyntax = (function () {
    ...
    BindingWhenOnSyntax2.prototype.whenAnyAncestorTagged = function (
        tag,
        value
    ) {
    ...
    BindingWhenOnSyntax2.prototype.whenNoAncestorTagged = function (
        tag,
        value
    ) {
    ...
    BindingWhenOnSyntax2.prototype.whenNoAncestorMatches = function (
        constraint
    ) {
...
var BindingToSyntax = (function () {
    ...
    BindingToSyntax2.prototype.toAutoNamedFactory = function (
        serviceIdentifier
    ) {
        this._binding.type = BindingTypeEnum.Factory
        this._binding.factory = function (context) {
...
var Container = (function () {
            ...
            return __generator4(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [
                            4,
                            this._deactivateSingletonsAsync(deactivations),
                        ]
                    case 2:
                        _b.sent()
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        this._bindingDictionary.traverse(
                            function (_key, value) {
                                promises.push(
                                    _this._deactivateSingletonsAsync(value)
                                )
                            }
                        )
    ...
    Container3.prototype.isBoundTagged = function (
        ...
        if (this._bindingDictionary.hasKey(serviceIdentifier)) {
            var bindings = this._bindingDictionary.get(serviceIdentifier)
            var request_1 = createMockRequest(
                this,
                serviceIdentifier,
                key,
                value
    ...
    Container3.prototype.getAllTagged = function (
        serviceIdentifier,
        key,
        value
    ) {
    ...
    Container3.prototype.getAllNamedAsync = function (
        serviceIdentifier,
        named2
    ) {
    ...
    Container3.prototype._deactivate = function (binding, instance2) {
        ...
        try {
            ...
            if (ex instanceof Error) {
                throw new Error(
                    ON_DEACTIVATION_ERROR(constructor.name, ex.message)
                )
            }
        }
    }
                ...
                return __generator4(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4,
                                this._deactivate.bind(this.parent)(
                                    binding,
                                    instance2
                                ),
                            ]
...
var PluralResolver = class {
    ...
    getSuffixes(code) {
        ...
        return rule.numbers.map((number) =>
    ...
    nest(str, fc) {
        ...
        while ((match = this.nestingRegexp.exec(str))) {
            ...
            clonedOptions =
                ...
                typeof clonedOptions.replace !== 'string'
                    ? clonedOptions.replace
                    : clonedOptions
...
var SettingsTab = class {
    ...
    dispatch() {
        ...
        const changed = ObjectHelper.compare(
            this.previous,
...
Simple = __decorateClass(
    [
        ...
        __decorateParam(
            0,
            inject(inversify_types_default['factory:placeholder'])
        ),
    ],
    Simple
)
...
MetaPlaceholder = __decorateClass(
    [
        ...
        __decorateParam(
            0,
            inject(inversify_types_default['component:extractor'])
        ),
        __decorateParam(
            1,
...
var HeadingPlaceholder = class extends AbstractPlaceholder {
    ...
    makeValue(path) {
        ...
        return (_c =
            (_b =
                (_a = this.factory(path, 'headings')) == null
                    ? void 0
                    : _a[0]) == null
                ? void 0
                : _b.heading) != null
...
var creator_config_default = new ContainerModule((bind) => {
    ...
    bind(
        inversify_types_default['factory:template:resolver']
    ).toAutoNamedFactory(inversify_types_default['creator:template'])
...
var ExplorerManager = class extends AbstractManager {
    ...
    doEnable() {
        if (
            !this.facade.isInternalPluginEnabled(
        ...
        if (!this.getExplorerView()) {
            this.logger.log(
                'Could not get view. Subscribe and wait for active leaf'
            )
            this.subscribe()
        } else {
            this.tryEnable()
    ...
    async doRefresh() {
        if (this.isState('enabled' /* Enabled */)) {
            return this.updateInternal(
                Object.values(this.getExplorerFileItems())
            )
        }
        return {}
    }
    ...
    getExplorerFileItems() {
        var _a, _b
        return (_b =
            (_a = this.getExplorerView()) == null ? void 0 : _a.fileItems) !=
            null
            ? _b
            : {}
    }
...
ExplorerManager = __decorateClass(
    [
        ...
        __decorateParam(
            1,
            inject(
                inversify_types_default['feature:explorer:file_mutator:factory']
            )
        ),
        __decorateParam(
            2,
...
var ExplorerSort = class {
    ...
    initView() {
        ...
        this.view =
            (_b =
                (_a = this.facade.getViewsOfType('file-explorer' /* FE */)) ==
                null
                    ? void 0
                    : _a[0]) != null
                ? _b
...
var ManagerComposer = class {
    ...
    async update(path, id3 = null) {
        ...
        for (const i of ids) {
            ...
            if (manager) {
                this.logger.log(
                    `Run update for [${path}] on [${manager.getId()}]`
                )
                promises.push(
...
var SearchManager = class extends AbstractFeature {
    ...
    enable() {
        if (
            !this.facade.isInternalPluginEnabled('global-search' /* Search */)
        ) {
            this.logger.info(
...
var FunctionReplacer = class _FunctionReplacer {
    ...
    enable() {
        ...
        this.target[this.method] = function (...args) {
            return self2.implementation.call(
                this,
                self2.args,
                args,
                self2.vanilla
...
var Alias = class {
    ...
    modify(alias) {
        var _a
        const key =
            (_a = this.getKey()) != null ? _a : this.getPossibleKeys()[0]
...
AliasFeature = __decorateClass(
    [
        ...
        __decorateParam(
            5,
            inject(inversify_types_default['feature:alias:config'])
        ),
    ],
    AliasFeature
)
...
var BookmarksManager = class extends AbstractFeature {
    ...
    tryEnable(subscribeOnActive = false) {
        var _a
        const leaf =
            (_a = this.facade.getLeavesOfType('bookmarks' /* Bookmarks */)) ==
            null
                ? void 0
                : _a[0]
        if (leaf.isVisible()) {
    ...
    onChanged(path = null) {
        ...
        for (const item of items) {
            const titleEl =
                (_a = itemDoms.get(item)) == null ? void 0 : _a.titleEl
...
var GraphManager = class extends AbstractManager {
    ...
    getFirstNode() {
        ...
        for (const view of this.getViews()) {
            const node =
                (_c = (
                    (_b = (_a = view.renderer) == null ? void 0 : _a.nodes) !=
                    null
                        ? _b
                        : []
                ).first()) != null
...
var FeatureService = class {
    ...
    createResolver(name) {
        ...
        return {
            resolve(path) {
                var _a
                return (_a = main.resolve(path)) != null
                    ? _a
...
NoteLinkFeature = __decorateClass(
    [
        ...
        __decorateParam(
            1,
            inject(inversify_types_default['service:note:link'])
        ),
        __decorateParam(2, inject(inversify_types_default['event:dispatcher'])),
        __decorateParam(
            3,
...
var WindowFrameFeature = class {
    ...
    updateTitle() {
        ...
        if (
            ...
            text =
                (_a = e == null ? void 0 : e.getDisplayText().trim()) != null
                    ? _a
                    : ''
        }
...
var feature_config_default = (container) => {
    ...
    container
        ...
        .toFunction(() => {
            ...
            return enabled
                ? container.get(
                      inversify_types_default['feature:explorer:sort']
                  )
                : null
        })
}
            ...
            const setting = new import_obsidian8.Setting(el)
                ...
                .addText((e) => {
                    ...
                    e.setValue((_a = tStorage.value()) != null ? _a : '')
                        .setPlaceholder(
                            templateStorage.get('common').get(type).value()
                        )
                        .onChange((v) => {
...
var AliasBuilder = class extends AbstractBuilder {
    ...
    buildValidatorDropdown(el) {
        ...
        this.validatorDropdown = new import_obsidian9.DropdownComponent(
            s.controlEl
        )
            .addOptions({
                ['fa' /* FrontmatterAuto */]: t2(
                    'feature.alias.validator.auto.name'
                ),
    ...
    buildStrategyDropdown(el) {
        ...
        const s = new import_obsidian9.Setting(el).setName(t2('strategy'))
        this.strategyDropdown = new import_obsidian9.DropdownComponent(
            s.controlEl
        )
            .addOptions({
                ['ensure' /* Ensure */]: t2(
                    'feature.alias.strategy.ensure.name'
                ),
                ['adjust' /* Adjust */]: t2(
                    'feature.alias.strategy.adjust.name'
                ),
                ['replace' /* Replace */]: t2(
                    'feature.alias.strategy.replace.name'
                ),
            })
...
var TemplatesBuilder = class extends AbstractBuilder2 {
        ...
        new import_obsidian10.Setting(this.container)
            ...
            .addText((text) => {
                ...
                return text
                    ...
                    .setValue(
                        (_a = this.item.get('common').get('main').value()) !=
                            null
                            ? _a
                            : ''
                    )
    ...
    buildFallbackTemplate() {
        new import_obsidian10.Setting(this.container)
            .setName(
                this.createDocFragment(t2('template.common.fallback.name'))
            )
...
var UtilBuilder = class {
    ...
    buildBoot(item, container) {
        new import_obsidian11.Setting(container)
            ...
            .addText((e) =>
                e
                    .setValue(item.get('delay').value().toString())
                    .onChange((s) => {
        ...
        switch (this.item.get('type').value()) {
            case 'replace' /* Replace */:
                additional = [
                    ...
                    createSpan(
                        '',
                        (e) => (e.innerHTML = '&emsp;#replacement#')
                    ),
                    ')',
                ]
                break
        ...
        this.setting.addDropdown((c) => {
            ...
            return c
                .addOptions({
                    ...
                    ['functionV2' /* FunctionV2 */]: t2(
                        'processor.functionV2.name'
                    ),
                })
                .setValue(
                    (_a = this.item.get('type').value()) != null ? _a : ''
                )
                .onChange((v) => {
                    var _a2, _b
                    ...
                    (e) => {
                        ...
                        e.appendChild(
                            createDiv(
                                ...
                                (e2) => e2.appendText(`${item.name}:`)
                            )
                        )
                        new import_obsidian14.TextComponent(e)
                            .setValue(
                                (_a = value == null ? void 0 : value[i]) != null
                                    ? _a
                                    : ''
                            )
    ...
    buildStrategy(el) {
        new import_obsidian15.Setting(el)
            ...
            .addDropdown((e) => {
                ...
                e.addOptions({
                    ['all' /* All */]: t2(
                        'feature.noteLink.strategy.options.all'
                    ),
...
var settings_config_default = (c) => {
    ...
    c.bind(
        ...
        c.isBoundNamed(
            inversify_types_default['settings:feature:builder'],
            name
        )
            ? c.getNamed(
                  inversify_types_default['settings:feature:builder'],
    ...
    c.bind(inversify_types_default['factory:settings:builder']).toFunction(
        (name) =>
            c.getAllNamed(inversify_types_default['settings:builder'], name)
    )
}
...
var FunctionProcessor = class {
    ...
    process(value) {
        var _a, _b
        return (_b =
            (_a = this.func) == null ? void 0 : _a.call(this, value)) != null
            ? _b
            : value
    }
    getType() {
...
var FunctionV2Processor = class {
    ...
    process(value) {
        ...
        return (_b = (_a = this.func) == null ? void 0 : _a.call(this, obj)) !=
            null
            ? _b
            : obj.title
    }
...
var Defer = class {
    constructor(factory) {
        ...
        this.promises.managers = new Promise(
            (r) => (this.resolves.managers = r)
        )
    }
    setFlag(flag) {
        if (!(this.state & flag)) {
...
var LoggerComposer = class {
    ...
    create(name) {
        if (!this.loggers.has(name)) {
            this.loggers.set(
                name,
                new Debugger(name, this.isEnabled.bind(this))
            )
        }
    ...
    getNoteLinks(path) {
        ...
        for (const link of links) {
            ...
            result.push({
                ...
                original: link.original,
                alias:
                    (_a = link == null ? void 0 : link.displayText) != null
                        ? _a
                        : null,
            })
        }
...
var EventDispatcher = class {
    ...
    dispatch(name, e) {
        ...
        for (const [i, item] of [
            ...((_b =
                (_a = this.events.get(name)) == null ? void 0 : _a.entries()) !=
            null
                ? _b
                : []),
        ]) {
...
ProcessorListener = __decorateClass(
    [
        ...
        __decorateParam(
            1,
            inject(inversify_types_default['processor:factory'])
        ),
        __decorateParam(
            2,
...
var FakeTitleElementService = class {
    ...
    getOriginal(id3) {
        var _a, _b
        return (_b =
            (_a = this.elements.get(id3)) == null ? void 0 : _a.original) !=
            null
            ? _b
            : null
    }
...
var ResultDomWrapper = class {
    ...
    process() {
        ...
        const lookup =
            (_c =
                (_b = (_a = this.replacer) == null ? void 0 : _a.getTarget()) ==
                null
                    ? void 0
...
var ObsidianFacade = class {
    ...
    getFileLinksCache(path) {
        var _a, _b
        return (_b =
            (_a = this.getFileCache(path)) == null ? void 0 : _a.links) != null
            ? _b
            : []
    }
    ...
    getActiveLeaf() {
        var _a, _b
        return (_b =
            (_a = this.app.workspace) == null ? void 0 : _a.activeLeaf) != null
            ? _b
            : null
    }
    getActiveFile() {
        var _a, _b
        return (_b =
            (_a = this.app.workspace) == null ? void 0 : _a.getActiveFile()) !=
            null
            ? _b
            : null
    }
...
var Migrator = class {
    ...
    migrate(version) {
        ...
        for (const version2 of versions) {
            ...
            console.log(
                `Migrate from ${currentVersion} to ${version2} by ${method}`
            )
            this[method]()
        }
        this.dispatcher.dispatch(
