...
I want you to rename "Best Practice" to "Explanation" in German "Erläuterungen".

Rename the files that start with "Best Practice". Rename the section in the "README.md" and Rename in "Best Practice.md".

Check if all instances of "Best Practices habe been rename". Filenames in English and content in German.
